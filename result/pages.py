...
class Result(Page):
    ...
    def vars_for_template(self):
        ...
        reward_str = 'total_reward' + str(self.participant.vars['reward_life'])
        reward = self.participant.vars[reward_str]

        reward_euro = round(reward, 2)
    ...
    def js_vars(self):
        ...
        return dict(url='https://survey.maximiles.com/complete?p=73956_bc5ef1c3&m='+username_value)
